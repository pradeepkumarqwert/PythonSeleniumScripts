...
def main():
    ...
    try:
        ...
        options.set_capability('browserVersion', '18.2')
        ...
        # --------------------------
        logo = driver.find_element(By.XPATH, "//div[@class='nav-header-container']//img[@class='svgIconImg' and @alt='logoIcon']")
        ...
        # 5. Search for Shirts
        # --------------------------
        search_bar = driver.find_element(By.XPATH, "//div[@class='nav-links']//input[@placeholder='Search']")
        search_bar.click()
        ...
        boys_checkbox = driver.find_element(By.XPATH, "//p[text()='Boys']//ancestor::div[contains(@class,'PlpWeb_filter-values')]//input")
        boys_checkbox.click()
